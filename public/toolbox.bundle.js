var Toolbox=(()=>{var W=Object.defineProperty;var xt=Object.getOwnPropertyDescriptor;var wt=Object.getOwnPropertyNames;var yt=Object.prototype.hasOwnProperty;var S=(p,t)=>{for(var e in t)W(p,e,{get:t[e],enumerable:!0})},vt=(p,t,e,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of wt(t))!yt.call(p,o)&&o!==e&&W(p,o,{get:()=>t[o],enumerable:!(s=xt(t,o))||s.enumerable});return p};var kt=p=>vt(W({},"__esModule",{value:!0}),p);var At={};S(At,{ActionItem:()=>q,CheckboxItem:()=>j,ContextMenu:()=>N,DataTable:()=>E,EditableText:()=>M,LoadingScreen:()=>U,MenuItem:()=>C,Navigator:()=>z,PopUp:()=>T,SeparatorItem:()=>A,Toast:()=>F,context_menu:()=>J,editable_text:()=>K,loading_screen:()=>ot,navigator:()=>V,pop_up:()=>X,table:()=>st,toast:()=>it});var J={};S(J,{ActionItem:()=>q,CheckboxItem:()=>j,ContextMenu:()=>N,MenuItem:()=>C,SeparatorItem:()=>A});var nt=`.context-menu{position:fixed;z-index:9999;min-width:180px;max-width:320px;background:#fff;border:1px solid #e5e7eb;border-radius:8px;box-shadow:0 10px 30px rgba(0,0,0,.12);padding:6px 0;font:14px/1.4 system-ui,-apple-system,Segoe UI,Roboto}\r
